...
torchrun --nproc_per_node=4 tools/train.py configs/nerffusion_nuscenes/nerffusion/fusion-bev256d2-lss.yaml --load_from pretrained/bevfusion-seg-half_x_range.pth --no-validate --run-dir runs/$DATE-nerffusion-max_seq_dist_6-kl1-dist2closest0.01-unet
